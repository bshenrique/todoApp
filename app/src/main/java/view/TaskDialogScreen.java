    ...
    private void initComponents() {
        ...
        jPanelTaskLayout.setVerticalGroup(
            ...
            .addGroup(jPanelTaskLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jScrollPaneNotes, javax.swing.GroupLayout.DEFAULT_SIZE, 122, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void jLabelToolBarAddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelToolBarAddMouseClicked
        ...
        try {
            ...
            if (!jTextFieldName.getText().isEmpty() 
                ...
                JOptionPane.showMessageDialog(rootPane,"Existem campos obrigatórios que não foram preenchidos");
            }
        } catch(Exception e) {
